...
function resizeWindow() {
  document.getElementById("toon-name").style.fontSize = 16*window.innerHeight/1000.;
  document.getElementById("toon-guild").style.fontSize = 14*window.innerHeight/1000.;
